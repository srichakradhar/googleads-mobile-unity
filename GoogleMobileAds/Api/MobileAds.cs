        ...
        internal static IClientFactory GetClientFactory() {
          if (clientFactory == null) {
            ...
            if (Application.platform == RuntimePlatform.IPhonePlayer) {
              typeName = "GoogleMobileAds.iOS.GoogleMobileAdsClientFactory,GoogleMobileAds.iOS";
            } else if (Application.platform == RuntimePlatform.Android) {
              typeName = "GoogleMobileAds.Android.GoogleMobileAdsClientFactory,GoogleMobileAds.Android";
            } else {
              typeName = "GoogleMobileAds.Unity.GoogleMobileAdsClientFactory,GoogleMobileAds.Unity";
            }
